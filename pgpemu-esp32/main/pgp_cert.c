...
void init_nonce_hash(const uint8_t* inp_nonce, const int datalen, uint8_t* nonce_hash) {
...
void generate_chal_0(const uint8_t* mac,
    ...
    aes_ctr(&ctx, main_data.nonce, the_challenge, 16, main_data.encrypted_challenge);
