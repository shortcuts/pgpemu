...
void test_decrypt_chal_0(const uint8_t* indata) {
    ...
    aes_ctr(&ctx, challenge->nonce, challenge->encrypted_main_challenge, 80, (uint8_t*)&main_data);
...
int main(int argc, char* argv[]) {
    ...
    const char expected[] = {
        0x1b, 0x77, 0xbc, 0x98, 0xad, 0x03, 0x54, 0x7e, 0x00, 0x49, 0xfa, 0x67, 0x5a, 0x10, 0x47, 0xd0
    };
    uint8_t main_key[16];
    memset(main_key, 0x43, 16);
